          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="w-16 h-16 bg-emerald-100 rounded-lg flex items-center justify-center">
                <Icon icon="solar:check-circle-bold-duotone" className="w-8 h-8 text-emerald-600" />
              </div>
            </div>
            <div className="flex items-center text-xs text-gray-500">
              <Icon icon="solar:alt-arrow-down-bold-duotone" className="w-4 h-4 mr-1 text-emerald-500" />
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="w-16 h-16 bg-blue-100 rounded-lg flex items-center justify-center">
                <Icon icon="solar:clock-circle-bold-duotone" className="w-8 h-8 text-blue-600" />
              </div>
            </div>
            <div className="flex items-center text-xs text-gray-500">
              <Icon icon="solar:alt-arrow-down-bold-duotone" className="w-4 h-4 mr-1 text-blue-500" />
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="w-16 h-16 bg-purple-100 rounded-lg flex items-center justify-center">
                <Icon icon="solar:dollar-bold-duotone" className="w-8 h-8 text-purple-600" />
              </div>
            </div>
            <div className="flex items-center text-xs text-gray-500">
              <Icon icon="solar:alt-arrow-down-bold-duotone" className="w-4 h-4 mr-1 text-purple-500" />
                  ...
                  {transactions.slice(0, 5).map((transaction) => (
                    ...
                    >
                      <div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center flex-shrink-0">
                        <Icon icon="solar:dollar-bold-duotone" className="w-5 h-5 text-purple-600" />
                      </div>
                      <div className="flex-1 min-w-0">
